...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {Q: oldTime, as: request, au: subs};
	});
	...
	return A3(
		...
		A2(
			...
			A2(
				$elm$json$Json$Decode$field,
				'target',
				A2($elm$json$Json$Decode$field, info.aJ, $elm$json$Json$Decode$bool))));
};
...
var $evancz$elm_playground$Playground$Mouse = F4(
	function (x, y, down, click) {
		return {N: click, aG: down, aA: x, aB: y};
	});
var $evancz$elm_playground$Playground$Time = $elm$core$Basics$identity;
var $elm$core$Set$Set_elm_builtin = $elm$core$Basics$identity;
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $evancz$elm_playground$Playground$emptyKeyboard = {L: false, aG: false, O: false, g: $elm$core$Set$empty, r: false, B: false, T: false, U: false, K: false};
...
var $evancz$elm_playground$Playground$toScreen = F2(
	function (width, height) {
		return {M: (-height) / 2, ad: height, r: (-width) / 2, B: width / 2, X: height / 2, az: width};
	});
			...
			case 2:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							y: A2($evancz$elm_playground$Playground$toScreen, viewport.az, viewport.ad)
						}));
			case 3:
				var w = msg.a;
				var h = msg.b;
			...
			case 0:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							ah: A3($evancz$elm_playground$Playground$updateKeyboard, isDown, key, computer.ah)
						}));
			case 5:
				var pageX = msg.a;
				var pageY = msg.b;
				var y = computer.y.X - pageY;
				var x = computer.y.r + pageX;
				return A3(
					$evancz$elm_playground$Playground$Game,
					vis,
					memory,
			...
			default:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							ah: $evancz$elm_playground$Playground$emptyKeyboard,
							f: A4($evancz$elm_playground$Playground$Mouse, computer.f.aA, computer.f.aB, false, false)
						}));
		}
	});
...
var $evancz$elm_playground$Playground$render = F2(
	function (screen, shapes) {
		var y = $elm$core$String$fromFloat(screen.M);
		var x = $elm$core$String$fromFloat(screen.r);
		var w = $elm$core$String$fromFloat(screen.az);
		var h = $elm$core$String$fromFloat(screen.ad);
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
...
var $author$project$Main$update = F2(
	function (computer, _v0) {
		...
		var y = _v0.b;
		return _Utils_Tuple2(
			x + $evancz$elm_playground$Playground$toX(computer.ah),
			y + $evancz$elm_playground$Playground$toY(computer.ah));
	});
...
var $evancz$elm_playground$Playground$image = F3(
	function (w, h, src) {
		return A6(
			...
			1,
			1,
			A3($evancz$elm_playground$Playground$Image, w, h, src));
	});
var $author$project$Main$javad = A3($evancz$elm_playground$Playground$image, 96, 96, 'https://i.imgur.com/9Km48vO.png');
...
var $evancz$elm_playground$Playground$lightBlue = $evancz$elm_playground$Playground$Hex('#729fcf');
...
var $author$project$Main$overlay = $evancz$elm_playground$Playground$group(
	_List_fromArray(
		[
			A2(
			...
			A2(
				...
				0.1,
				A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$lightRed, 200, 400))),
			A2(
			...
			A2(
				$evancz$elm_playground$Playground$fade,
				0.1,
				A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$lightBlue, 200, 400)))
		]));
...
var $author$project$Main$snow = function (computer) {
	var spacing = 35;
	var row = $evancz$elm_playground$Playground$group(
		_List_fromArray(
			[
				A3(
				...
				spacing * (-5),
				0,
				A2($evancz$elm_playground$Playground$circle, $evancz$elm_playground$Playground$white, 3)),
				A3(
				$evancz$elm_playground$Playground$move,
				spacing * (-4),
				0,
	...
	return $evancz$elm_playground$Playground$group(
		_List_fromArray(
			[
				A3(
				$evancz$elm_playground$Playground$move,
				A4($evancz$elm_playground$Playground$wave, -3, 3, 1, computer.l),
				spacing * 5,
				row),
				A2(
				$evancz$elm_playground$Playground$moveLeft,
...
var $author$project$Main$largeSpike = function (color) {
	return A2(
...
var $author$project$Main$smallSpike = function (color) {
	return A2(
		$evancz$elm_playground$Playground$polygon,
		color,
		_List_fromArray(
...
var $author$project$Main$star = $evancz$elm_playground$Playground$group(
	_List_fromArray(
		[
			A2(
			$evancz$elm_playground$Playground$rotate,
			45,
			$author$project$Main$smallSpike($evancz$elm_playground$Playground$orange)),
			A2(
			$evancz$elm_playground$Playground$rotate,
			135,
			$author$project$Main$smallSpike($evancz$elm_playground$Playground$orange)),
			...
			315,
			$author$project$Main$smallSpike($evancz$elm_playground$Playground$orange)),
			$author$project$Main$largeSpike($evancz$elm_playground$Playground$yellow),
			A2(
			$evancz$elm_playground$Playground$rotate,
			90,
			$author$project$Main$largeSpike($evancz$elm_playground$Playground$yellow)),
...
var $author$project$Main$tree = $evancz$elm_playground$Playground$group(
	_List_fromArray(
		[
			A2(
			$evancz$elm_playground$Playground$moveDown,
			125,
			A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$brown, 10, 20)),
			A2(
			$evancz$elm_playground$Playground$polygon,
			$evancz$elm_playground$Playground$darkGreen,
			_List_fromArray(
				[
					_Utils_Tuple2(-20, 0),
					_Utils_Tuple2(0, 40),
	...
	function (computer, _v0) {
		...
		return _List_fromArray(
			[
				...
				0.75,
				A2($evancz$elm_playground$Playground$moveUp, 70, $author$project$Main$star)),
				$author$project$Main$overlay,
				A2(
				$evancz$elm_playground$Playground$fade,
				0.9,
				$author$project$Main$snow(computer)),
				A3($evancz$elm_playground$Playground$move, x, y, $author$project$Main$javad)
			]);
	});
